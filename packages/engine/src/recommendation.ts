...
/** Recomendación por prioridades y huecos libres (sin ubicación). */
export function getRecommendation(input: RecommendInput): RecommendationDto | null {
